...
describe('validateOpenAPISpec', () => {
  ...
  it('should throw error for invalid OpenAPI specification', () => {
    ...
    expect(() => validateOpenAPISpec(invalidSpec))
      .toThrow('Invalid OpenAPI specification: Missing or invalid info object');
  });

  it('should throw error for non-object input', () => {
    expect(() => validateOpenAPISpec('not an object'))
      .toThrow('Invalid OpenAPI specification: Input must be an object');
    expect(() => validateOpenAPISpec(null))
      .toThrow('Invalid OpenAPI specification: Input must be an object');
    expect(() => validateOpenAPISpec(undefined))
      .toThrow('Invalid OpenAPI specification: Input must be an object');
  });
  ...
  it('should throw error for missing paths', () => {
    ...
    expect(() => validateOpenAPISpec(invalidSpec))
      .toThrow('Invalid OpenAPI specification: Missing or invalid paths object');
  });
