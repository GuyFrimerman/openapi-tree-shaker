...
export type SecuritySchemeObject = OpenAPIV2.SecuritySchemeObject | OpenAPIV3.SecuritySchemeObject;

export interface ParsedReference {
  type: 'schemas' | 'parameters' | 'responses' | 'requestBodies' | 'securitySchemes';
  name: string;
}
