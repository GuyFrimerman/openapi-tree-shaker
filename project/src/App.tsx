  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 px-2 sm:py-8 sm:px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold text-gray-800">{steps[currentStep].title}</h1>
              {currentStep > 0 && (
                <button
        ...
        {/* Current Step */}
        <div className="bg-white rounded-lg shadow-md">{steps[currentStep].component}</div>
      </div>
    </div>
  );
}
